...
class RookTest extends Specification {
    ...
    def 'Should find all available fields when rook is placed at #description'() {
        ...
        new Coordinates(0, 1) | BoardFactory.getBoard("King,w,0,7")            | 13       | '0,1 coordinates'
        new Coordinates(1, 0) | BoardFactory.getBoard("King,w,4,0")            | 10       | '1,0 coordinates'
        new Coordinates(0, 0) | BoardFactory.getBoard("Rook,b,0,5;Rook,w,5,0") | 9        | '1,0 coordinates'
    }
}
